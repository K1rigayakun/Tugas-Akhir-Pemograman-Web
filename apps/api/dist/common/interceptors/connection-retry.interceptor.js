...
var ConnectionRetryInterceptor_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ConnectionRetryInterceptor = void 0;
 ...
 * ```
 */
let ConnectionRetryInterceptor = ConnectionRetryInterceptor_1 = class ConnectionRetryInterceptor {
    constructor() {
        this.logger = new common_1.Logger(ConnectionRetryInterceptor_1.name);
        this.maxRetries = 3;
    ...
    intercept(context, next) {
        ...
        return next.handle().pipe((0, operators_1.catchError)((error) => {
            ...
            if (this.isConnectionError(error)) {
                ...
                return this.retryWithBackoffObservable(() => next.handle(), requestId, path);
            }
     ...
     */
    retryWithBackoffObservable(operation, requestId, path) {
        let attempt = 0;
        return operation().pipe((0, operators_1.retryWhen)((errors) => errors.pipe((0, operators_1.mergeMap)((error) => {
            attempt++;
...
exports.ConnectionRetryInterceptor = ConnectionRetryInterceptor;
exports.ConnectionRetryInterceptor = ConnectionRetryInterceptor = ConnectionRetryInterceptor_1 = __decorate([
...
async function retryWithBackoff(operation, maxRetries = 3, initialDelay = 100) {
    const logger = new common_1.Logger('retryWithBackoff');
    let lastError = null;
...
//# sourceMappingURL=connection-retry.interceptor.js.map