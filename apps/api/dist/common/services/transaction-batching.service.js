...
exports.TransactionBatchingService = void 0;
 ...
 * ```
 */
let TransactionBatchingService = class TransactionBatchingService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    /**
     ...
     * ```
     */
    async executeInTransaction(operations, timeoutMs = 10000) {
     ...
     * ```
     */
    async executeParallelInTransaction(queries, timeoutMs = 10000) {
        return this.executeInTransaction(async (tx) => {
            // Execute all queries in parallel using Promise.all
            return await Promise.all(queries.map(query => query(tx)));
        }, timeoutMs);
    }
    /**
    ...
    async executeWithRetry(operations, options = {}) {
        const { maxRetries = 3, timeoutMs = 10000, initialDelayMs = 100 } = options;
        let lastError = null;
...
exports.TransactionBatchingService = TransactionBatchingService;
exports.TransactionBatchingService = TransactionBatchingService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], TransactionBatchingService);
//# sourceMappingURL=transaction-batching.service.js.map