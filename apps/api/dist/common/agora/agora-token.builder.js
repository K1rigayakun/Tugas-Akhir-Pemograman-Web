...
exports.AgoraRole = void 0;
exports.buildRtcToken = buildRtcToken;
exports.generateAuctionToken = generateAuctionToken;
...
(function (AgoraRole) {
    ...
    AgoraRole[AgoraRole["PUBLISHER"] = 1] = "PUBLISHER";
    /** Subscriber — hanya bisa terima audio/video (penonton) */
    AgoraRole[AgoraRole["SUBSCRIBER"] = 2] = "SUBSCRIBER";
})(AgoraRole || (exports.AgoraRole = AgoraRole = {}));
/** Privilege types */
const Privileges = {
    kJoinChannel: 1,
 ...
 */
function buildRtcToken(appId, appCertificate, channelName, uid, role, privilegeExpiredTs) {
    // Build message
    const privileges = {};
    ...
    const signature = (0, crypto_1.createHmac)("sha256", appCertificate)
        .update(toSign)
        .digest("base64");
...
function packPrivileges(privileges) {
 ...
 */
function generateAuctionToken(appId, appCertificate, auctionId, uid = 0, isHost = false, ttlSeconds = 3600) {
    ...
    const token = buildRtcToken(appId, appCertificate, channelName, uid, role, privilegeExpiredTs);
    return {
        appId,
        token,
        channel: channelName,
...
//# sourceMappingURL=agora-token.builder.js.map