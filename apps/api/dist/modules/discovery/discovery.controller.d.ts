...
export declare class DiscoveryController {
    ...
    leaderboard(category: string, limit?: string): Promise<{
        position: number;
        userId: string;
        username: string;
        rank: string;
    ...
    museumItems(limit?: string, rarity?: string): import(".prisma/client").Prisma.PrismaPromise<({
        auction: {
            _count: {
                bids: number;
            };
    ...
    highlights(): import(".prisma/client").Prisma.PrismaPromise<{
        id: string;
        name: string;
        theme: string;
