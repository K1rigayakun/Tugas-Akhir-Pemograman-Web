...
], VaultController.prototype, "submitItem", null);
__decorate([
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    ...
    __metadata("design:returntype", Promise)
], VaultController.prototype, "getStatus", null);
exports.VaultController = VaultController = __decorate([
    (0, swagger_1.ApiTags)('vault-offering'),
    (0, common_1.Controller)('vault-offering'),
