...
exports.BidModule = BidModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, wallet_module_1.WalletModule, notification_module_1.NotificationModule, ai_module_1.AiModule],
        controllers: [bid_controller_1.BidController],
        providers: [bid_service_1.BidService, bid_gateway_1.BidGateway],
        exports: [bid_service_1.BidService, bid_gateway_1.BidGateway],
    })
], BidModule);
