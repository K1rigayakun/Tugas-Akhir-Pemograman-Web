...
const achievement_listener_1 = require("./achievement.listener");
...
exports.AchievementModule = AchievementModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        imports: [rank_module_1.RankModule, bid_module_1.BidModule],
        controllers: [achievement_controller_1.AchievementController],
        providers: [achievement_service_1.AchievementService, achievement_listener_1.AchievementListener],
